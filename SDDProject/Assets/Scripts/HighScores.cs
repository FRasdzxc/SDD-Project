...
{
    const string privateCode = "lRoeAcJpoUqFrOgZ46aLewm1eNs3J-sUe-MQlkkbki3g";  //Key to Upload New Info
    const string publicCode = "6290c7918f40bb11c05fc6e7";   //Key to download
    const string webURL = "http://dreamlo.com/lb/lRoeAcJpoUqFrOgZ46aLewm1eNs3J-sUe-MQlkkbki3g"; //  Website the keys are for
